<div class="card card-primary" style="margin-top: -30px">
  <div class="card-header">
    <h4>Riwayat Pengajuan KTP-el WNA</h4>
    <div class="card-header-action">
    <a href="<?= base_url('auth/riwayat/ktp')?>" class="btn btn-icon icon-left btn-danger"><i class="fas fa-arrow-left"></i> Kembali</a>
    </div>
  </div>
  <div class="card-body">
