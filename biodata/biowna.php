<div class="card card-primary" style="margin-top: -30px">
  <div class="card-header">
    <h4>Riwayat Pencatatan Biodata WNA</h4>
      ...
      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
        ...
        <tbody>
          ...
          <tr>
            <td><?= $no++?></td>
            <td><?= $dt->namakk?></td>
              <td><?= date("d-m-y",strtotime($dt->tgl_pengajuan_wna))?></td>
              <td>
                <?php 
              ...
              <td><a href="#" data-toggle="modal" data-target="#detail-data<?= $dt->id_wna?>" class="btn btn-primary">Detail</a></td>
            </tr>

        <div class="modal fade" id="detail-data<?= $dt->id_wna?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
