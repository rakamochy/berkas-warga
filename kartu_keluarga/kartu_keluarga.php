<div class="card card-primary" style="margin-top: -30px">
  <div class="card-header">
    <h4>Riwayat Pengajuan Kartu keluarga</h4>
    <div class="card-header-action">
    <a href="<?= base_url('auth/riwayat')?>" class="btn btn-icon icon-left btn-danger"><i class="fas fa-arrow-left"></i> Kemabali</a>
    </div>
  </div>
  <div class="card-body">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $dt->namakk?></td>
              ...
              <td><a href="#" data-toggle="modal" data-target="#detail-data<?= $dt->id_kk?>" class="btn btn-primary">Detail</a>
            </tr>

        <div class="modal fade" id="detail-data<?= $dt->id_kk?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
